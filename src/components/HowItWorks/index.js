    ...
    <S.HowItWorksWrapper className="HowItWorks">
      <Container>
        <header className="HowItWorks__header">
          <h2 className="color-primary">Como funciona a seleção dos alunos</h2>
        </header>
        <div className="HowItWorks__steps">
          <div className="HowItWorks__step">
            ...
            <div className="HowItWorks__step-text">
              <p>
                Chegamos nos alunos por meio de cursinhos populares e líderes de
                comunidades
              </p>
            </div>
            {isDesktop && <Lupa />}
          ...
          <div className="HowItWorks__step">
            ...
            <div className="HowItWorks__step-text">
              <p>
                ...
                possibilitando com que os alunos assistam pelo menos três horas
                de vídeo aulas por dia{" "}
              </p>
            </div>
            {isDesktop && <Phone />}
          </div>
