...
const Slide = () => {
  ...
  const settings = {
    ...
    nextArrow: <NextArrow slideDirection={slideDirection} />,
    prevArrow: <PrevArrow slideDirection={slideDirection} />,
    responsive: [
      {
        breakpoint: 768,
        settings: {
...
const PrevArrow = ({ onClick, slideDirection }) => {
  return (
    <SlideArrow
      isLeft={true}
...
const NextArrow = ({ onClick, slideDirection }) => {
  return (
    <SlideArrow
      isLeft={false}
      onClick={onClick}
